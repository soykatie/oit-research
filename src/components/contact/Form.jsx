  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        Буду рада ответить на любые возникнувшие вопросы. Пожалуйста, свяжитесь
        со мной по эл.почте или телефону, в случаях невозможности заполнения
        данной формы
      </p>
      <div className="mx-2">
