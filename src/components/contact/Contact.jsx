...
const addressData = [
  {
    icon: faLocationDot,
    title: "Адрес",
    description: "Минск, ул. Бобруйская, 9",
  },
  {
    icon: faEnvelope,
    title: "Email",
    description: "Ukleiko@bsu.by, e.ukleiko@gmail.com",
  },
  {
    icon: faPhone,
    title: "Рабочий телефон",
    description: "209-53-23 (внутр. 62-99)",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                Время работы: пн-пт 8:30 - 12:30 (специалист ОМКО ГУОД БГУ),
                пт-сб (ассистент кафедры веб-технологий и компьютерного
                моделирования ММФ БГУ)
              </p>
            </div>
