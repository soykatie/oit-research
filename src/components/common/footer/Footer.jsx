...
/* Footer nabLinks */
const navItems = [
  { id: 1, name: "Глвная", url: "Home" },
  { id: 2, name: "Обо мне", url: "About" },
  { id: 3, name: "Реферат", url: "Process" },
  { id: 4, name: "Портфолио", url: "Portfolio" },
  { id: 5, name: "НИР", url: "Services" },
  { id: 6, name: "Контакты", url: "Contact" },
];
